...
func extractPartyFromPacs00200110BranchAndFinancialInstitutionIdentification6(agent *pacs_002_001_10.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacs00200110PostalAddress24(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		...
		res.Identification.PostalAddress = postalAddressFromPacs00200110PostalAddress24(agent.FinInstnId.PstlAdr)
	}
...
func extractPartyFromPacs00400110BranchAndFinancialInstitutionIdentification6(agent *pacs_004_001_10.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacs00400110PostalAddress24(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		res.Identification.Name = string(*agent.FinInstnId.Nm)
		res.Identification.PostalAddress = postalAddressFromPacs00400110PostalAddress24(agent.FinInstnId.PstlAdr)
	}
	if agent.FinInstnId.Othr != nil {
		res.Identification.Other = &addressbook.Other{
			Id: string(agent.FinInstnId.Othr.Id),
...
func extractPartyFromPacs00700110BranchAndFinancialInstitutionIdentification6(agent *pacs_007_001_10.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacs00700110PostalAddress24(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		res.Identification.Name = string(*agent.FinInstnId.Nm)
		res.Identification.PostalAddress = postalAddressFromPacs00700110PostalAddress24(agent.FinInstnId.PstlAdr)
	}
	if agent.FinInstnId.Othr != nil {
		res.Identification.Other = &addressbook.Other{
			Id: string(agent.FinInstnId.Othr.Id),
...
func postalAddressFromPacs00200110PostalAddress24(po24 *pacs_002_001_10.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
...
func postalAddressFromPacs00400110PostalAddress24(po24 *pacs_004_001_10.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
...
func postalAddressFromPacs00700110PostalAddress24(po24 *pacs_007_001_10.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
