...
func extractPartyFromPacs00900109BranchAndFinancialInstitutionIdentification6(agent *pacs_009_001_09.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacs00900109PostalAddress24(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		...
		res.Identification.PostalAddress = postalAddressFromPacs00900109PostalAddress24(agent.FinInstnId.PstlAdr)
	}
...
func postalAddressFromPacs00900109PostalAddress24(po24 *pacs_009_001_09.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
