...
func extractPartyFromPacsV09BranchAndFinancialInstitutionIdentification6(agent *pacs_v09.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacsV09PostalAddress24(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		...
		res.Identification.PostalAddress = postalAddressFromPacsV09PostalAddress24(agent.FinInstnId.PstlAdr)
	}
...
func postalAddressFromPacsV09PostalAddress24(po24 *pacs_v09.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
