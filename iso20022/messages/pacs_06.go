...
func extractPartyFromPacsV06BranchAndFinancialInstitutionIdentification5(agent *pacs_v06.BranchAndFinancialInstitutionIdentification5, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacsV06PostalAddress6(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		...
		res.Identification.PostalAddress = postalAddressFromPacsV06PostalAddress6(agent.FinInstnId.PstlAdr)
	}
...
func postalAddressFromPacsV06PostalAddress6(po6 *pacs_v06.PostalAddress6) (res *addressbook.PostalAddress) {
	if po6 == nil {
		return nil
	}
