...
func extractPartyFromPacsV08BranchAndFinancialInstitutionIdentification5(agent *pacs_v08.BranchAndFinancialInstitutionIdentification5, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.BrnchId != nil {
		...
		res.Branch.PostalAddress = postalAddressFromPacsV08PostalAddress6(agent.BrnchId.PstlAdr)
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		...
		res.Identification.PostalAddress = postalAddressFromPacsV08PostalAddress6(agent.FinInstnId.PstlAdr)
	}
...
func extractPartyFromPacsV08BranchAndFinancialInstitutionIdentification6(agent *pacs_v08.BranchAndFinancialInstitutionIdentification6, res *addressbook.Party) {
	if agent == nil {
		return
	}
	...
	if agent.FinInstnId.Nm != nil && agent.FinInstnId.PstlAdr != nil {
		res.Identification.Name = string(*agent.FinInstnId.Nm)
		res.Identification.PostalAddress = postalAddressFromPacsV08PostalAddress24(agent.FinInstnId.PstlAdr)
	}
	if agent.FinInstnId.Othr != nil {
		res.Identification.Other = &addressbook.Other{
			Id: string(agent.FinInstnId.Othr.Id),
...
func postalAddressFromPacsV08PostalAddress6(po6 *pacs_v08.PostalAddress6) (res *addressbook.PostalAddress) {
	if po6 == nil {
		return nil
	}
...
func postalAddressFromPacsV08PostalAddress24(po24 *pacs_v08.PostalAddress24) (res *addressbook.PostalAddress) {
	if po24 == nil {
		return nil
	}
