...
type CreditTransferTransaction39 struct {
	...
	IntrBkSttlmDt     *iso.ISODate                                  `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 IntrBkSttlmDt,omitempty"`
	...
	AccptncDtTm       *iso.ISODateTime                              `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 AccptncDtTm,omitempty"`
	PoolgAdjstmntDt   *iso.ISODate                                  `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 PoolgAdjstmntDt,omitempty"`
...
type DateAndPlaceOfBirth1 struct {
	BirthDt     iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 BirthDt"`
...
type DatePeriod2 struct {
	FrDt iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 FrDt"`
	ToDt iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 ToDt"`
}
...
type DocumentLineIdentification1 struct {
	...
	RltdDt *iso.ISODate       `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 RltdDt,omitempty"`
}
...
type Garnishment3 struct {
	...
	Dt                *iso.ISODate                       `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 Dt,omitempty"`
...
type GroupHeader93 struct {
	...
	CreDtTm           iso.ISODateTime                               `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 CreDtTm"`
...
type SettlementDateTimeIndication1 struct {
	DbtDtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 DbtDtTm,omitempty"`
	CdtDtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 CdtDtTm,omitempty"`
}
...
type TaxPeriod2 struct {
	Yr     *iso.ISODate          `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.008.001.08 Yr,omitempty"`
