...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.002.001.14
...
func (v Document) Validate() error {
	...
	baseName := "Document"
	iso.AddError(&errs, baseName+".FIToFIPmtStsRpt", v.FIToFIPmtStsRpt.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v FIToFIPaymentStatusReportV14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusReportV14"
	iso.AddError(&errs, baseName+".GrpHdr", v.GrpHdr.Validate())
	if v.OrgnlGrpInfAndSts != nil {
		for indx := range v.OrgnlGrpInfAndSts {
			iso.AddError(&errs, baseName+".OrgnlGrpInfAndSts", v.OrgnlGrpInfAndSts[indx].Validate())
		}
	}
	if v.TxInfAndSts != nil {
		for indx := range v.TxInfAndSts {
			iso.AddError(&errs, baseName+".TxInfAndSts", v.TxInfAndSts[indx].Validate())
		}
	}
...
func (v GroupHeader120) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader120"
	...
	if v.OrgnlBizQry != nil {
		iso.AddError(&errs, baseName+".OrgnlBizQry", v.OrgnlBizQry.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v NumberOfTransactionsPerStatus5) Validate() error {
	...
	iso.AddError(&errs, baseName+".DtldNbOfTxs", v.DtldNbOfTxs.Validate())
	iso.AddError(&errs, baseName+".DtldSts", v.DtldSts.Validate())
	if v.DtldCtrlSum != nil {
		iso.AddError(&errs, baseName+".DtldCtrlSum", v.DtldCtrlSum.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v OriginalGroupHeader22) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalGroupHeader22"
	...
	if v.OrgnlCtrlSum != nil {
		iso.AddError(&errs, baseName+".OrgnlCtrlSum", v.OrgnlCtrlSum.Validate())
	}
	if v.GrpSts != nil {
		iso.AddError(&errs, baseName+".GrpSts", v.GrpSts.Validate())
	}
	if v.StsRsnInf != nil {
		for indx := range v.StsRsnInf {
			iso.AddError(&errs, baseName+".StsRsnInf", v.StsRsnInf[indx].Validate())
		}
	}
	if v.NbOfTxsPerSts != nil {
		for indx := range v.NbOfTxsPerSts {
			iso.AddError(&errs, baseName+".NbOfTxsPerSts", v.NbOfTxsPerSts[indx].Validate())
		}
	}
	if errs.Empty() {
		return nil
...
func (v PaymentTransaction161) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction161"
	if v.StsId != nil {
		iso.AddError(&errs, baseName+".StsId", v.StsId.Validate())
	}
	...
	if v.PrcgDt != nil {
		iso.AddError(&errs, baseName+".PrcgDt", v.PrcgDt.Validate())
	}
	if v.FctvIntrBkSttlmDt != nil {
		iso.AddError(&errs, baseName+".FctvIntrBkSttlmDt", v.FctvIntrBkSttlmDt.Validate())
	}
	if v.AcctSvcrRef != nil {
		iso.AddError(&errs, baseName+".AcctSvcrRef", v.AcctSvcrRef.Validate())
	}
	if v.ClrSysRef != nil {
...
func (v StatusReasonInformation14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "StatusReasonInformation14"
	if v.Orgtr != nil {
