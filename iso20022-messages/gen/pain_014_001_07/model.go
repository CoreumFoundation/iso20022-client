...
type DateAndDateTime2Choice struct {
	Dt   *iso.ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:pain.014.001.07 Dt,omitempty"`
	DtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:pain.014.001.07 DtTm,omitempty"`
}

type DateAndPlaceOfBirth1 struct {
	BirthDt     iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:pain.014.001.07 BirthDt"`
...
type GroupHeader87 struct {
	...
	CreDtTm  iso.ISODateTime        `xml:"urn:iso:std:iso:20022:tech:xsd:pain.014.001.07 CreDtTm"`
...
type OriginalGroupInformation30 struct {
	...
	OrgnlCreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:pain.014.001.07 OrgnlCreDtTm"`
