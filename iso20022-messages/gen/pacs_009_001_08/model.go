...
type GroupHeader93 struct {
	...
	CreDtTm           iso.ISODateTime         `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08 CreDtTm"`
	...
	IntrBkSttlmDt     iso.ISODate             `xml:"urn:iso:std:iso:20022:tech:xsd:pacs.009.001.08 IntrBkSttlmDt"`
