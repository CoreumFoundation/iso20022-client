...
// Models for urn:iso:std:iso:20022:tech:xsd:admn.002.001.01 with prefix 'rs'
...
type GrpHdr struct {
	...
	CreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:admn.002.001.01 CreDtTm"`
}
