...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.003.001.11
...
func (v Document) Validate() error {
	...
	baseName := "Document"
	iso.AddError(&errs, baseName+".FIToFICstmrDrctDbt", v.FIToFICstmrDrctDbt.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v DirectDebitTransaction12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "DirectDebitTransaction12"
	...
	if v.PreNtfctnId != nil {
		iso.AddError(&errs, baseName+".PreNtfctnId", v.PreNtfctnId.Validate())
	}
	if v.PreNtfctnDt != nil {
		iso.AddError(&errs, baseName+".PreNtfctnDt", v.PreNtfctnDt.Validate())
	}
	if errs.Empty() {
		return nil
	}
...
func (v DirectDebitTransactionInformation31) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "DirectDebitTransactionInformation31"
	...
	if v.DrctDbtTx != nil {
		iso.AddError(&errs, baseName+".DrctDbtTx", v.DrctDbtTx.Validate())
	}
...
func (v FIToFICustomerDirectDebitV11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFICustomerDirectDebitV11"
	iso.AddError(&errs, baseName+".GrpHdr", v.GrpHdr.Validate())
	for indx := range v.DrctDbtTxInf {
		iso.AddError(&errs, baseName+".DrctDbtTxInf", v.DrctDbtTxInf[indx].Validate())
	}
	if v.SplmtryData != nil {
		for indx := range v.SplmtryData {
			iso.AddError(&errs, baseName+".SplmtryData", v.SplmtryData[indx].Validate())
...
func (v GroupHeader125) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader125"
