...
type CaseAssignment5 struct {
	...
	CreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.026.001.07 CreDtTm"`
}
...
type DateAndDateTime2Choice struct {
	Dt   *iso.ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.026.001.07 Dt,omitempty"`
	DtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.026.001.07 DtTm,omitempty"`
}
...
type UnderlyingGroupInformation1 struct {
	...
	OrgnlCreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.026.001.07 OrgnlCreDtTm"`
}
...
type UnderlyingPaymentTransaction4 struct {
	...
	OrgnlIntrBkSttlmDt  iso.ISODate                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.026.001.07 OrgnlIntrBkSttlmDt"`
}
