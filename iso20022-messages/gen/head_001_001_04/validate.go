...
// Validations for urn:iso:std:iso:20022:tech:xsd:head.001.001.04
...
func (v BusinessApplicationHeader8) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "BusinessApplicationHeader8"
	if v.CharSet != nil {
...
func (v BusinessApplicationHeaderV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "BusinessApplicationHeaderV04"
	if v.CharSet != nil {
		iso.AddError(&errs, baseName+".CharSet", v.CharSet.Validate())
	}
	iso.AddError(&errs, baseName+".Fr", v.Fr.Validate())
...
func (v Party51Choice) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Party51Choice"
	if v.OrgId != nil {
