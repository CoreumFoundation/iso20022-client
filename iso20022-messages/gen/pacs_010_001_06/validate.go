...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.010.001.06
...
func (v Document) Validate() error {
	...
	baseName := "Document"
	iso.AddError(&errs, baseName+".FIDrctDbt", v.FIDrctDbt.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v CreditTransferTransaction66) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction66"
	iso.AddError(&errs, baseName+".CdtId", v.CdtId.Validate())
	if v.BtchBookg != nil {
...
func (v DirectDebitTransactionInformation33) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "DirectDebitTransactionInformation33"
	...
	if v.InstrForDbtrAgt != nil {
		iso.AddError(&errs, baseName+".InstrForDbtrAgt", v.InstrForDbtrAgt.Validate())
	}
	if v.Purp != nil {
...
func (v FinancialInstitutionDirectDebitV06) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FinancialInstitutionDirectDebitV06"
	iso.AddError(&errs, baseName+".GrpHdr", v.GrpHdr.Validate())
	for indx := range v.CdtInstr {
		iso.AddError(&errs, baseName+".CdtInstr", v.CdtInstr[indx].Validate())
	}
	if v.SplmtryData != nil {
		for indx := range v.SplmtryData {
			iso.AddError(&errs, baseName+".SplmtryData", v.SplmtryData[indx].Validate())
...
func (v GroupHeader119) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader119"
...
func (v Max210Text) Validate() error {
	if err := iso.ValidateMinLength(string(v), 1); err != nil {
		return err
	}
	if err := iso.ValidateMaxLength(string(v), 210); err != nil {
		return err
	}
	return nil
}
