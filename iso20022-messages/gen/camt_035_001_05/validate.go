...
func (v Document) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Document"
	iso.AddError(&errs, baseName+".PrtryFrmtInvstgtn", v.PrtryFrmtInvstgtn.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v ProprietaryData6Reduced) Validate() error {
	...
	iso.AddError(&errs, baseName+".OrigRefs", v.OrigRefs.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v ProprietaryData7TCH) Validate() error {
	...
	iso.AddError(&errs, baseName+".Data", v.Data.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v ProprietaryFormatInvestigationV05) Validate() error {
	...
	iso.AddError(&errs, baseName+".PrtryData", v.PrtryData.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v Max35TextTCH3) Validate() error {
	if err := iso.ValidateEnumeration(string(v), "ACK", "ACWP"); err != nil {
		return err
	}
	if err := iso.ValidateMinLength(string(v), 1); err != nil {
		return err
