...
type CaseAssignment5 struct {
	...
	CreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 CreDtTm"`
}
...
type OriginalGroupHeader14 struct {
	...
	OrgnlCreDtTm iso.ISODateTime            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 OrgnlCreDtTm"`
...
type ResolutionData1 struct {
	...
	IntrBkSttlmDt  *iso.ISODate                      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.09 IntrBkSttlmDt,omitempty"`
