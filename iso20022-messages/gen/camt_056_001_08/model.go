...
type CaseAssignment5 struct {
	...
	CreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 CreDtTm"`
}
...
type DateAndPlaceOfBirth1 struct {
	BirthDt     iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 BirthDt"`
...
type OriginalGroupHeader15 struct {
	...
	OrgnlCreDtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 OrgnlCreDtTm,omitempty"`
}
...
type PaymentTransaction106 struct {
	...
	OrgnlIntrBkSttlmDt  iso.ISODate                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.056.001.08 OrgnlIntrBkSttlmDt"`
