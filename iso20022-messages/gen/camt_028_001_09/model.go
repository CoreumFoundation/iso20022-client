...
type CaseAssignment5 struct {
	...
	CreDtTm iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.028.001.09 CreDtTm"`
}
...
type DateAndDateTime2Choice struct {
	Dt   *iso.ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.028.001.09 Dt,omitempty"`
	DtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.028.001.09 DtTm,omitempty"`
}

type DateAndPlaceOfBirth1 struct {
	BirthDt     iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.028.001.09 BirthDt"`
...
type UnderlyingPaymentTransaction4 struct {
	...
	OrgnlIntrBkSttlmDt  iso.ISODate                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.028.001.09 OrgnlIntrBkSttlmDt"`
}
