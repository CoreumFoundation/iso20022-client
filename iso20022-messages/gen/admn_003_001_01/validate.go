...
func (v Document) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Document"
	iso.AddError(&errs, baseName+".AdmnSignOffReq", v.AdmnSignOffReq.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v SignOffRequest) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "SignOffRequest"
	iso.AddError(&errs, baseName+".GrpHdr", v.GrpHdr.Validate())
	iso.AddError(&errs, baseName+".SignOffReq", v.SignOffReq.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
