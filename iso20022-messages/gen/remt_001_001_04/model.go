...
type DateAndDateTime2Choice struct {
	Dt   *iso.ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 Dt,omitempty"`
	DtTm *iso.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 DtTm,omitempty"`
}

type DateAndPlaceOfBirth1 struct {
	BirthDt     iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 BirthDt"`
...
type DatePeriod2 struct {
	FrDt iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 FrDt"`
	ToDt iso.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 ToDt"`
}
...
type DocumentLineIdentification1 struct {
	...
	RltdDt *iso.ISODate       `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 RltdDt,omitempty"`
}
...
type GroupHeader79 struct {
	...
	CreDtTm  iso.ISODateTime        `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 CreDtTm"`
...
type TaxPeriod2 struct {
	Yr     *iso.ISODate          `xml:"urn:iso:std:iso:20022:tech:xsd:remt.001.001.04 Yr,omitempty"`
